...
(function() {
  var Game, Magic, Player, UUID, World, util;
  ...
  Game = (function() {
    ...
    Game.prototype.init = function() {
      ...
      this.players = [];
      id = UUID();
      robot = new Player(id, "Julian", "robot", 600, 300, this.world);
    ...
    Game.prototype.onPlayerAttack = function(player) {
      ...
      if (player.attack()) {
        ...
        if (target !== null && distance < player.attackRange && player.faceDirection === player.realtiveDirection(target)) {
          return target.gotHit(10, player.counterDirection(player.faceDirection));
        }
      }
    };
    ...
    Game.prototype.handle_collision = function() {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        player = _ref[_i];
        _results.push(this.detectCollision(player));
      }
      return _results;
    };

    Game.prototype.detectCollision = function(object) {
      var otherObject, rect1, rect2, _i, _len, _ref, _results;
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        if (!((rect2.x2 < rect1.x1) || (rect2.x1 > rect1.x2) || (rect2.y1 > rect1.y2) || (rect2.y2 < rect1.y1))) {
          _results.push(object.collisionHandler(otherObject));
        } else {
